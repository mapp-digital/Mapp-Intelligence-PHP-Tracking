...
test-latest:
	make start TYPE="test" CONTAINER_VERSION="latest" XDEBUG_VERSION="3.2.1" RUNKIT_VERSION="7-4.0.0a6" PHPUNIT_VERSION="~9.0"
...
test-php8:
	make start TYPE="test" CONTAINER_VERSION="8-cli" XDEBUG_VERSION="3.2.1" RUNKIT_VERSION="7-4.0.0a6" PHPUNIT_VERSION="~9.0"
