 ...
 */
class MappIntelligenceConsumerCurlTest extends PHPUnit\Framework\TestCase
{
    private $longText;
    ...
    {
        new MappIntelligenceConsumerCurl(array(
            'debug' => true
        ));
    ...
    {
        $consumer = new MappIntelligenceConsumerCurl(array(
        ...
        $fileContent = MappIntelligenceUnitUtil::getErrorLog();
        $this->assertContains(
            'Send batch data via cURL call to https://analytics01.wt-eu02.net/123451234512345/batch (1 req.)',
            $fileContent[0]
        );
        $this->assertContains('Batch request responding the status code 200', $fileContent[1]);
    }
    ...
    public function testBatchRequestResponding404()
    {
        ...
        $this->assertContains('Batch request responding the status code 404', $fileContent[1]);
        $this->assertContains('[0]:', $fileContent[2]);
    }
